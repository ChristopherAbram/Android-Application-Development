package fi.jamk.aad.l3334.imageviewexercise;
...
public class MainActivity extends AppCompatActivity {
    ...
    private final String PATH = "http://www.tapety-na-pulpit.net/web/tapety/";
    // example image names (change to your own if needed...)
    private String[] images = {"tapety-na-pulpit-wiosna-76/obraz/lg.jpg","tapety-na-pulpit-wiosna-75/obraz/lg.jpg","tapety-na-pulpit-wiosna-74/obraz/lg.jpg"};
