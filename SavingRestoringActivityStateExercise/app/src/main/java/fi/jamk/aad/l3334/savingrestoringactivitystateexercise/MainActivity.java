package fi.jamk.aad.l3334.savingrestoringactivitystateexercise;
...
public class MainActivity extends Activity implements TextEntryDialogFragment.TextEntryDialogListener {
    ...
    public void buttonClicked(View view) {
        ...
        //android.support.v4.app.FragmentManager manager = (android.support.v4.app.FragmentManager)getFragmentManager();
        eDialog.show(getFragmentManager(), "Text");
    }
